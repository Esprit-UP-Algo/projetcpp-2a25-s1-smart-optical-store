...
public:
    ...
    bool ajouterProduitVente(int idVente, const QString &refProduit, int quantite, double prixUnitaire);
    QString getProductAddError() const { return productAddError; }  // Get last product add error
...
private:
    ...
    mutable QString productAddError;  // Store last product add error
};
