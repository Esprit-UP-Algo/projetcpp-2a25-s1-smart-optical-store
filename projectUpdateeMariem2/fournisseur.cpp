...
bool Fournisseur::ajouter()
{
    ...
    // NOMS EXACTS selon votre screenshot
    query.prepare(
        "INSERT INTO FOURNISSEUR "
        "(ID_FOURNISSEUR, NOM_ENTREPRISE, NOM_CONTACT, "
        "EMAIL, TELEPHONE, TYPE_PRODUIT_FOURNIS, "
        "CONDITION_PAIEMENT, HISTORIQUE_COMMANDE_PASSEE) "
    ...
    query.bindValue(":tel",       telephone.toInt());  // CONVERTIR EN INT POUR NUMBER
...
// Modification - TÉLÉPHONE COMME NOMBRE
bool Fournisseur::modifier(int id)
{
    ...
    query.prepare(
        ...
        "TYPE_PRODUIT_FOURNIS = :type_prod, "
        "CONDITION_PAIEMENT = :cond_paie, "
        "HISTORIQUE_COMMANDE_PASSEE = :hist "
        "WHERE ID_FOURNISSEUR = :id"
        );
