...
public:
    ...
    void setupUi(QMainWindow *DashboardWindow)
    {
        ...
        DashboardWindow->setStyleSheet(QString::fromUtf8("background-color: #b8e2f2; color: black;"));
...
"}"));
        ...
        logoutButton->setGeometry(QRect(0, 620, 201, 51));
...
"}"));
        ...
        contentWidget->setStyleSheet(QString::fromUtf8("background-color: rgb(41, 102, 148);"));
...
""));
        ...
        font2.setBold(true);
        customersCountLabel->setFont(font2);
        ...
        productsCountLabel->setFont(font2);
        ...
        todayRevenueLabel->setFont(font2);
        ...
        font3.setBold(true);
        recentSalesLabel->setFont(font3);
...
""));
    ...
    void retranslateUi(QMainWindow *DashboardWindow)
    {
        ...
        groupBox->setTitle(QCoreApplication::translate("DashboardWindow", "Tableau de board", nullptr));
        pushButton->setText(QCoreApplication::translate("DashboardWindow", "Stock", nullptr));
        pushButton_2->setText(QCoreApplication::translate("DashboardWindow", "Ventes", nullptr));
        pushButton_5->setText(QCoreApplication::translate("DashboardWindow", "Fournisseur", nullptr));
        pushButton_3->setText(QCoreApplication::translate("DashboardWindow", "Employes", nullptr));
        pushButton_4->setText(QCoreApplication::translate("DashboardWindow", "Clients", nullptr));
        logoutButton->setText(QCoreApplication::translate("DashboardWindow", "Logout", nullptr));
        welcomeLabel->setText(QCoreApplication::translate("DashboardWindow", "Smart Optical Store", nullptr));
        ...
        todaySalesLabel->setText(QCoreApplication::translate("DashboardWindow", "0.00 DT", nullptr));
        label_5->setText(QCoreApplication::translate("DashboardWindow", "This Week Revenue", nullptr));
        todayRevenueLabel->setText(QCoreApplication::translate("DashboardWindow", "0.00 DT", nullptr));
        label_6->setText(QCoreApplication::translate("DashboardWindow", "This Month Revenue", nullptr));
        lowStockLabel->setText(QCoreApplication::translate("DashboardWindow", "0.00 DT", nullptr));
