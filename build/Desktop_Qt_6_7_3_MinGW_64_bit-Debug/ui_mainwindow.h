...
""));
        ...
        stackedWidget->setGeometry(QRect(300, 30, 1081, 591));
...
"color: rgb(0, 0, 0);"));
        pushButton_exportExcel = new QPushButton(page_10);
        pushButton_exportExcel->setObjectName("pushButton_exportExcel");
        pushButton_exportExcel->setGeometry(QRect(320, 490, 151, 41));
        QFont font2;
        font2.setPointSize(9);
        font2.setBold(true);
        pushButton_exportExcel->setFont(font2);
        pushButton_exportExcel->setStyleSheet(QString::fromUtf8("border: 3px solid #1E3A8A;\n"
...
""));
        ...
        topRightLogoLabel = new QLabel(page_10);
        topRightLogoLabel->setObjectName("topRightLogoLabel");
        topRightLogoLabel->setGeometry(QRect(940, 0, 60, 60));
...
""));
        ...
        groupBox_2->setGeometry(QRect(20, 0, 271, 611));
...
"}\n"
""));
        logoutButton = new QPushButton(groupBox_2);
        logoutButton->setObjectName("logoutButton");
        logoutButton->setGeometry(QRect(0, 540, 271, 51));
...
""));
        ...
        menubar->setGeometry(QRect(0, 0, 1449, 25));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_exportExcel->setText(QCoreApplication::translate("MainWindow", "Export format Excel", nullptr));
