...
public:
    ...
    void setupUi(QMainWindow *GestionClients)
    {
        ...
        GestionClients->resize(1539, 1603);
...
"     QPushButton#btnProduit:hover, QPushButton#btnVentes:hover, QPushButton#btnEmployes:hover, QPushButton#btnClients:hover, QPushButton#btnD"
                        "ashboard:hover { background-color: #357fa3; }\n"
...
"     QTableWidget { background-color: white; gridline-color: #90caf9; selection-background-color: #48a4d6; selection-color: w"
                        "hite; alternate-background-color: #e9f5fc; border: 1px solid #89c3e2; border-radius: 8px; }\n"
...
"    "));
        ...
        b1 = new QPushButton(sidebarFrame);
        b1->setObjectName("b1");
...
"}"));
        ...
        sidebarLayout->addWidget(b1);

        b2 = new QPushButton(sidebarFrame);
        b2->setObjectName("b2");
...
"}"));
        ...
        sidebarLayout->addWidget(b2);

        b3 = new QPushButton(sidebarFrame);
        b3->setObjectName("b3");
...
"}"));
        ...
        sidebarLayout->addWidget(b3);

        b4 = new QPushButton(sidebarFrame);
        b4->setObjectName("b4");
...
"}"));
        ...
        sidebarLayout->addWidget(b4);

        b5 = new QPushButton(sidebarFrame);
        b5->setObjectName("b5");
...
"    background-color: #c62828; /* pressed effect */\n"
"}\n"
""));
        ...
        labelLogoTopRight->setMaximumSize(QSize(60, 60));
        labelLogoTopRight->setPixmap(QPixmap(QString::fromUtf8(":/images/logof.jpg")));
        labelLogoTopRight->setScaledContents(true);

        headerLayout->addWidget(labelLogoTopRight);
    ...
    void retranslateUi(QMainWindow *GestionClients)
    {
        ...
        b1->setText(QCoreApplication::translate("GestionClients", "Stock", nullptr));
        b2->setText(QCoreApplication::translate("GestionClients", "Ventes", nullptr));
        b3->setText(QCoreApplication::translate("GestionClients", "Employes", nullptr));
        b4->setText(QCoreApplication::translate("GestionClients", "Clients", nullptr));
        b5->setText(QCoreApplication::translate("GestionClients", "Fournisseur", nullptr));
        logoutButton->setText(QCoreApplication::translate("GestionClients", "Logout", nullptr));
