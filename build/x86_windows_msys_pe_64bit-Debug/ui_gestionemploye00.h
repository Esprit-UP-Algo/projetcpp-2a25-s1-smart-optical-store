...
public:
    ...
    void setupUi(QWidget *gestionemploye00)
    {
        ...
        gestionemploye00->resize(1421, 825);
...
"color:white;"));
        ...
        pushButton_5->setGeometry(QRect(700, 680, 131, 31));
...
"color:white;"));
        ...
        pushButton_6->setGeometry(QRect(860, 680, 141, 31));
...
"}"));
        ...
        logoutButton->setGeometry(QRect(0, 640, 189, 51));
...
""));
    ...
    void retranslateUi(QWidget *gestionemploye00)
    {
        ...
        logoutButton->setText(QCoreApplication::translate("gestionemploye00", "Logout", nullptr));
    } // retranslateUi
