...
"}"));
        ...
        lineEdit_new_password->setEchoMode(QLineEdit::EchoMode::Password);
        ...
        lineEdit_confirm_password->setEchoMode(QLineEdit::EchoMode::Password);
