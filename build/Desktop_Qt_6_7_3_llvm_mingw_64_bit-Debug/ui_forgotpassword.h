...
public:
    ...
    void setupUi(QDialog *ForgotPassword)
    {
        ...
        groupBox->setGeometry(QRect(50, 30, 500, 440));
...
"}"));
        ...
        label_new_password->setGeometry(QRect(100, 240, 300, 20));
        ...
        lineEdit_new_password->setGeometry(QRect(100, 270, 300, 41));
        ...
        label_confirm_password->setGeometry(QRect(100, 330, 300, 20));
        ...
        lineEdit_confirm_password->setGeometry(QRect(100, 360, 300, 41));
        ...
        pushButton_reset->setGeometry(QRect(100, 410, 140, 50));
...
"}"));
        ...
        pushButton_cancel->setGeometry(QRect(260, 410, 140, 50));
