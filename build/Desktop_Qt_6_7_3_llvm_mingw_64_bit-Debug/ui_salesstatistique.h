...
public:
    ...
    void setupUi(QDialog *SalesStatistique)
    {
        ...
        SalesStatistique->setStyleSheet(QString::fromUtf8("background-color: #1e1e1e;\n"
"color: #e0e0e0;"));
        ...
        titleLabel->setStyleSheet(QString::fromUtf8("color: #4a9eff;"));
        ...
        refreshButton->setStyleSheet(QString::fromUtf8("background-color: #4a9eff;\n"
"color: white;\n"
"padding: 8px 16px;\n"
"border-radius: 5px;\n"
"font-weight: bold;"));
...
"}"));
        ...
        paymentChartWidget->setStyleSheet(QString::fromUtf8("background-color: #2d2d2d;\n"
...
"border-radius: 5px;"));
        ...
        paymentMethodsText->setStyleSheet(QString::fromUtf8("background-color: #2d2d2d;\n"
"border: 1px solid #4a9eff;\n"
"border-radius: 5px;\n"
"color: #e0e0e0;"));
...
"}"));
        ...
        clientsChartWidget->setStyleSheet(QString::fromUtf8("background-color: #2d2d2d;\n"
"border: 1px solid #4a9eff;\n"
"border-radius: 5px;"));
        ...
        topClientsText->setStyleSheet(QString::fromUtf8("background-color: #2d2d2d;\n"
"border: 1px solid #4a9eff;\n"
"border-radius: 5px;\n"
"color: #e0e0e0;"));
...
"}"));
        ...
        statusChartWidget->setStyleSheet(QString::fromUtf8("background-color: #2d2d2d;\n"
"border: 1px solid #4a9eff;\n"
"border-radius: 5px;"));
        ...
        statusText->setStyleSheet(QString::fromUtf8("background-color: #2d2d2d;\n"
"border: 1px solid #4a9eff;\n"
"border-radius: 5px;\n"
"color: #e0e0e0;"));
        ...
        exportButton->setStyleSheet(QString::fromUtf8("background-color: #4a9eff;\n"
"color: white;\n"
"padding: 10px 20px;\n"
"border-radius: 5px;\n"
"font-weight: bold;"));
