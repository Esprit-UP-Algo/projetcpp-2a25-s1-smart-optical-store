...
public:
    explicit FournisseurWindow(const QString &role = "admin", QWidget *parent = nullptr);
    ~FournisseurWindow();
    
    // Singleton pattern
    static FournisseurWindow* getInstance(const QString &role = "admin", QWidget *parent = nullptr);
...
private slots:
    ...
    // Navigation buttons
    void on_pushButton_clicked();      // Stock
    void on_pushButton_2_clicked();    // Ventes
    void on_pushButton_3_clicked();    // Clients
    void on_pushButton_4_clicked();    // Employes
    void on_pushButton_5_clicked();    // Fournisseur (self)
